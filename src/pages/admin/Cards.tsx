...
const Cards = () => {
    ...
    const imageURL = 'https://picsum.photos/id/0/192/213'
  ...
  return (
    ...
    <div className="mt-5">
      ...
      <div className="w-full max-w-sm mt-6 lg:max-w-full lg:flex">
        ...
        />
        <div
          className="flex flex-col justify-between p-4 leading-normal bg-white border-b border-l border-r border-gray-200 rounded-b lg:border-l-0 lg:border-t lg:border-gray-200 lg:rounded-b-none lg:rounded-r"
        >
          <div className="mb-8">
