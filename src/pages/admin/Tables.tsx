        ...
        <div className="my-6 overflow-hidden bg-white rounded-md shadow">
          <table className="w-full text-left border-collapse">
            <thead className="border-b">
              <tr>
                <th
                  className="px-5 py-3 text-sm font-medium text-gray-100 uppercase bg-indigo-800"
                >
                  City
                </th>
                <th
            ...
            <table className="min-w-full">
              <thead>
                <tr>
                  ...
                  <th
                    className="px-6 py-3 bg-gray-100 border-b border-gray-200"
                  />
                </tr>
              </thead>
